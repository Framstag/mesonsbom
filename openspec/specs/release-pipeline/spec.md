# Release Pipeline for Meson Builds

## Purpose

The system shall provide a release workflow that, when a Git version tag is pushed, builds source archives, generates the project's own SBOM, creates a statically linked x86-64 binary, and publishes a GitHub Release with all artifacts.
